import {
  stegaClean
} from "./chunk-D7F5X7JJ.js";
import {
  __privateAdd,
  __privateGet,
  __privateSet,
  __publicField
} from "./chunk-J2UEWKVQ.js";
...
function s2(r2, a4) {
  ...
  function l3(e2) {
    const t2 = o2.reduce((e3, t3) => (e3[t3] = function() {
  ...
  return l3.use = function(e2) {
    ...
    if (e2.onReturn && u3.onReturn.length > 0)
...
var u = c(function() {
  ...
  return a2 = function(t2) {
    if (!t2)
      return {};
    for (var r2 = {}, o3 = e2(t2).split("\n"), n4 = 0; n4 < o3.length; n4++) {
      var s3 = o3[n4], a4 = s3.indexOf(":"), i2 = e2(s3.slice(0, a4)).toLowerCase(), u3 = e2(s3.slice(a4 + 1));
...
var d = (e2, t2) => {
  ...
  }, a4.open(o3.method, o3.url, true), a4.withCredentials = !!o3.withCredentials, i2 && a4.setRequestHeader)
    for (const e3 in i2)
      i2.hasOwnProperty(e3) && a4.setRequestHeader(e3, i2[e3]);
...
var f2 = c((p2 || (p2 = 1, function(e2, t2) {
  t2.formatArgs = function(t3) {
    ...
    function n4(e4, t4) {
      ...
      for (; s5 < e4.length; )
        if (n5 < t4.length && (t4[n5] === e4[s5] || "*" === t4[n5]))
          "*" === t4[n5] ? (r2 = n5, o3 = s5, n5++) : (s5++, n5++);
        else {
          if (-1 === r2)
            return false;
          n5 = r2 + 1, o3++, s5 = o3;
    ...
    return t3.debug = t3, t3.default = t3, t3.coerce = function(e4) {
      ...
      for (const s5 of t3.skips)
        if (n4(e4, s5))
          return false;
      for (const s5 of t3.names)
        if (n4(e4, s5))
          return true;
      return false;
      ...
      return a3 = function(i2, a4) {
        ...
        if ("number" === l3 && isFinite(i2))
          return a4.long ? (c4 = i2, (u3 = Math.abs(c4)) >= n5 ? o3(c4, u3, n5, "day") : u3 >= s5 ? o3(c4, u3, s5, "hour") : u3 >= t4 ? o3(c4, u3, t4, "minute") : u3 >= e4 ? o3(c4, u3, e4, "second") : c4 + " ms") : function(r3) {
            var o4 = Math.abs(r3);
      ...
      for (let t4 = 0; t4 < e4.length; t4++)
        s5 = (s5 << 5) - s5 + e4.charCodeAt(t4), s5 |= 0;
...
var P = (e2 = {}) => ((e3) => {
  ...
  return { onError: (e4, r2) => {
    ...
    if (null !== (l3 = o3.body) && "object" == typeof l3 && "function" == typeof l3.pipe || !c4(e4, u3, o3) || u3 >= i2)
      return e4;
    var l3;
...
function _fetch(client, httpRequest, _stega, query, _params = {}, options = {}) {
  ...
  return stega.enabled ? $request.pipe(
    combineLatestWith(
      from(
        import("./stegaEncodeSourceMap-UDGSWPQS.js").then(function(n4) {
...
var eventSourcePolyfill = defer(() => import("./browser-YYG6LNCP.js")).pipe(
